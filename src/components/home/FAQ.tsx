...
const faqData = [
  ...
  },
  {
    ...
    answer: "Да, при покупке аппарата тренинг для ваших мастеров — в подарок. Обучение проводят наши технологи: настройка параметров под разные типы кожи и волос, техника работы, безопасность и протоколы процедур. Выдаём сертификат."
  },
  {
  ...
  },
  {
    ...
    answer: "Да, работаем с банками-партнёрами и лизинговыми компаниями — оформляем рассрочку до 24 месяцев и лизинг для юрлиц и ИП. Одобрение обычно в день обращения, первоначальный взнос обсуждается индивидуально. Оставьте заявку — менеджер пришлёт условия под ваш бюджет."
  }
];
